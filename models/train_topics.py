...
def main():
    ...
    data_path = root / "datasets" / "devotional_topics.csv"
    ...
    y = df["topic"].astype(str).str.lower()
    ...
    clf.fit(X, y)
    joblib.dump(clf, models_dir / "topic_model.joblib")
    joblib.dump(v, models_dir / "topic_vectorizer.joblib")
